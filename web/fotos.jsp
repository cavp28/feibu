<%-- 
    Document   : fotos
    Created on : Jul 24, 2015, 9:49:06 PM
    Author     : david
--%>
...
<head>
    ...
    <%
        ...
        String jndiUrl6 = "java:comp/env/AlbumesFacade";
        AlbumesFacade albumesFacade = (AlbumesFacade) context.lookup(jndiUrl6); 
    %>
  </head>
  <body>
    <div id="navbar-full">
        ...
        <nav class="navbar navbar-default navbar-transparent navbar-fixed-top" role="navigation">
          <div class="container">
            ...
            <%if (request.getParameter("idAlbum")!=null){
                ...
                Albumes album = null;
                album = albumesFacade.find(Integer.parseInt(request.getParameter("idAlbum")));
                usuario=usuariosFacade.find(album.getIdusuario());
                List <Imagenes> listaImagenes = album.getImagenesList();
            %>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right navbar-opts">
                ...
                <li><a href="Amigos.jsp"><i class="fa fa-users"></i>Friends</a></li>
                <li class="active"><a href="fotos.jsp"><i class="fa fa-file-image-o"></i>Fotos</a></li>
              </ul>
            </div>
          </div>
        </nav>
        ...
        <div class="row">
          <div class="panel panel-default panel-user-photos">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/1.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/2.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/3.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/4.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/5.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/6.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/7.jpg" /></div>
                <div class="col-md-3 col-sm-4 col-xs-6"><img class="img-responsive show-in-modal" src="img/Photos/8.jpg" /></div>
              </div>
            </div>
